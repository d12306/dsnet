...
class ResNeXtBottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, base_width=64, widen_factor=2, cardinality=8):
        """ Constructor
        Args:
    ...
    def forward(self, x):
        ...
        return self.bn_final(F.relu(residual + bottleneck, inplace=True))
