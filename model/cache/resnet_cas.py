...
class Bottleneck_cas(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        super(Bottleneck_cas, self).__init__()
        ...
        self.fc = nn.Linear(self.expansion * planes, 10)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.layer4 = self._make_layer_(Bottleneck_cas, 512, num_blocks[3], stride=2)
...
def ResNet18_cas(num_classes):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def ResNet34_cas(num_classes):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)


def ResNet50_cas(num_classes):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes)


def ResNet101_cas(num_classes):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes)


def ResNet152_cas(num_classes):
